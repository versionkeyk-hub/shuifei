...
function specValue(specification: Specification, key: string): unknown {
  const packageValue = specification.package?.[key];
  if (packageValue !== null && packageValue !== undefined && packageValue !== '') return packageValue;
  const payloadValue = specification.payload?.[key];
